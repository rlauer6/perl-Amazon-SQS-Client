...
use Carp qw( carp croak );
 ...
 my $request = new Amazon::SQS::Model::GetQueueAttributesRequest( 
								 {
 ...
 # @TODO: set request. Action can be passed as Amazon::SQS::Model::GetQueueAttributesRequest
  ...
  sub invokeGetQueueAttributes {
      ...
      eval {
              my $response = $service->getQueueAttributes($request);
                ...
                print("        GetQueueAttributesResponse\n");
                if ($response->isSetGetQueueAttributesResult()) { 
                    print("            GetQueueAttributesResult\n");
