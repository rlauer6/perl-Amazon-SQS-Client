...
use Carp qw( carp croak );
 ...
 # @TODO: set request. Action can be passed as Amazon::SQS::Model::AddPermissionRequest
 ...
 # invokeAddPermission($service, $request);
    ...
    #
  sub invokeAddPermission {
      my ($service, $request) = @_;  
      eval {
              my $response = $service->addPermission($request);
              
                print ("Service Response\n");
                print ("=============================================================================\n");

                print("        AddPermissionResponse\n");
